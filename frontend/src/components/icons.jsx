// Shared small SVG icon components. Extracted from Contact.jsx / App.jsx so
// the same path data isn't duplicated across every place a GitHub/LinkedIn/
// mail glyph is rendered (Contact page, footer, IconPopover trigger).
const PATHS = {
