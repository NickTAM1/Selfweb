    ...
    <div className="container">
      ...
      <Reveal className="box" index={0}>
        ...
        <div className="contact-link-row">
          <a className="btn-glass btn-link" href="mailto:2584718806q@gmail.com">
            <svg
            ...
            >
              <path
                fill="currentColor"
                d="M2 5.5A1.5 1.5 0 0 1 3.5 4h17A1.5 1.5 0 0 1 22 5.5v13a1.5 1.5 0 0 1-1.5 1.5h-17A1.5 1.5 0 0 1 2 18.5v-13Zm2.2.5 7.3 6.15a.75.75 0 0 0 .96 0L19.8 6H4.2ZM20 7.4l-6.6 5.55a2.75 2.75 0 0 1-3.53 0L4 7.4V18h16V7.4Z"
              />
            </svg>
            2584718806q@gmail.com
          </a>
          <a
          ...
          >
            ...
            >
              <path
                fill="currentColor"
                d="M4.98 3.5a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5ZM2.4 9.75h5.15V21H2.4V9.75Zm7.9 0h4.93v1.54h.07c.69-1.24 2.37-2.55 4.87-2.55 5.2 0 6.16 3.28 6.16 7.54V21H21v-5.34c0-1.27-.02-2.9-1.85-2.9-1.85 0-2.14 1.36-2.14 2.81V21h-5.7V9.75Z"
              />
            </svg>
